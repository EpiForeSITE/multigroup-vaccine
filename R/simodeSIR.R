...
#' @param times optional argument for times at which the solution is to be calculated; if NULL
#' (the default) the solution will be computed up to the time at which the total number of
#' infectious individuals is sufficiently close to zero (outbreak extinction)
...
#' @export
simodeSIR <- function(transmrates, recoveryrate, popsize, initR, initI, initV, times = NULL) {
