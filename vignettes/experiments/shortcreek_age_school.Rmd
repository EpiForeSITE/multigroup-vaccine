...
knitr::kable(data.frame(group = rownames(cm),
                        size = grouppops,
                        vax = paste0(round(100 * groupvax / grouppops), "%"),
