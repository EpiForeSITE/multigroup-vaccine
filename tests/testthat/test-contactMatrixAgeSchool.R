...
test_that("contactMatrixAgeSchool() works correctly for one school age group with three schools
  ...
  schportion <- c(0.6, 0.7, 0.8)

  schoolfrac <- schoolpops / sum(schoolpops)
  f <- (1 - schportion) * schoolpops
  schportionfrac <- f / sum(f)
  ...
  expect_equal(cmas[3, 3], cmp[3, 3] * (schportion[1] + (1 - schportion[1]) * schportionfrac[1]))
  expect_equal(cmas[3, 4], cmp[3, 3] * (1 - schportion[1]) * schportionfrac[2])
  expect_equal(cmas[3, 5], cmp[3, 3] * (1 - schportion[1]) * schportionfrac[3])
  expect_equal(cmas[3, 6], cmp[3, 4])
  expect_equal(cmas[4, 1], cmp[3, 1])
  expect_equal(cmas[4, 2], cmp[3, 2])
  expect_equal(cmas[4, 3], cmp[3, 3] * (1 - schportion[2]) * schportionfrac[1])
  expect_equal(cmas[4, 4], cmp[3, 3] * (schportion[2] + (1 - schportion[2]) * schportionfrac[2]))
  expect_equal(cmas[4, 5], cmp[3, 3] * (1 - schportion[2]) * schportionfrac[3])
  expect_equal(cmas[4, 6], cmp[3, 4])
  expect_equal(cmas[5, 1], cmp[3, 1])
  expect_equal(cmas[5, 2], cmp[3, 2])
  expect_equal(cmas[5, 3], cmp[3, 3] * (1 - schportion[3]) * schportionfrac[1])
  expect_equal(cmas[5, 4], cmp[3, 3] * (1 - schportion[3]) * schportionfrac[2])
  expect_equal(cmas[5, 5], cmp[3, 3] * (schportion[3] + (1 - schportion[3]) * schportionfrac[3]))
